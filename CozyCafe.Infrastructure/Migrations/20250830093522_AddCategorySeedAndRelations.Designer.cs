...
namespace CozyCafe.Infrastructure.Migrations
{
    ...
    [Migration("20250830093522_AddCategorySeedAndRelations")]
    partial class AddCategorySeedAndRelations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CozyCafe.Models.Domain.ForUser.CartItemOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CozyCafe.Models.Domain.ForUser.CartItemOption", b =>
                {
                    b.HasOne("CozyCafe.Models.Domain.ForUser.CartItem", "CartItem")
                        .WithMany("SelectedOptions")
